...
alg_name = 'HAT ANALYSIS TOOL - RUN RECAP'
alg_version = '1.1.0'
...
def main():
    ...
    if data_settings["algorithm"]["flags"]["public_check_spreadsheet"]:
        ...
        public_online_gdrive(data_settings["data"]["dynamic"]["outcome"]["check"]["api_key"],
                             data_settings["data"]["dynamic"]["outcome"]["check"]["sheet_name"], models_check,
                             runs_check, time_run)
...
def public_online_gdrive(api_key, sheet_name, models_check, runs_check, time_run):
